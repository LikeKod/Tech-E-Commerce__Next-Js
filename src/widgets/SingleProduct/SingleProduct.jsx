                        ...
                        <div className="w-1/2">
                            ...
                            <div className="flex items-center gap-x-6 mb-6">
                                ...
                                <div className="flex gap-2">
                                    <button className="w-20 h-8 rounded-full bg-red-500   hover:bg-red-600 focus:outline-none focus:ring-4 focus:ring-gray-200">red</button>
                                    <button className="w-20 h-8 rounded-full bg-yellow-300  hover:bg-yellow-400 focus:outline-none focus:ring-4 focus:ring-gray-200">yellow</button>
                                </div>
                            </div>
